...
try {
    ...
    echo '<h1 class="nom_propos">Le Formulaire est pas rempli correctement.</h1>';
    echo '<h1 class="nom_propos">Mailer Error: Vous avez pas bien compléter les champs avec * ( ' . $mail->ErrorInfo.')</h1>';
    echo '<h1 class="nom_propos">Merci de retourner sur la page Contact pour le compléter comme il se doit ;)</h1>';
